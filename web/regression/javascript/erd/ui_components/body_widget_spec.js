...
describe('ERD BodyWidget', ()=>{
  ...
  it('event nodesSelectionChanged', ()=>{
  ...
  it('event linksSelectionChanged', ()=>{
  ...
  it('event positionChanged', ()=>{
    bodyInstance.diagram.fireEvent({}, 'positionChanged', true);
    setTimeout(()=>{
      expect(body.state().dirty).toBe(true);
    });
  });
